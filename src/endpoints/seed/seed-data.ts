...
export const abonamentsData = [
  // GYM Subscriptions
  {
    ...
    cta: { label: 'Alege Basic', linkType: 'custom' as const, url: '/contact' },
    highlighted: false,
    order: 1,
  },
  {
    ...
    cta: { label: 'Alege Premium', linkType: 'custom' as const, url: '/contact' },
    highlighted: true,
  ...
  },
  {
    ...
    cta: { label: 'Alege VIP', linkType: 'custom' as const, url: '/contact' },
    highlighted: false,
    order: 3,
  },
  // SPA Subscriptions
  {
    ...
    cta: { label: 'Rezervă acum', linkType: 'custom' as const, url: 'tel:+40264123456' },
    highlighted: false,
    order: 1,
  },
  {
    ...
    cta: { label: 'Contactează-ne', linkType: 'custom' as const, url: '/contact' },
    highlighted: true,
  ...
  // Solar Subscriptions
  {
    ...
    cta: { label: 'Cumpără', linkType: 'custom' as const, url: '/contact' },
    highlighted: false,
    order: 1,
  },
  {
  ...
  // Combo Package
  {
    ...
    cta: { label: 'Alege pachetul', linkType: 'custom' as const, url: '/contact' },
    highlighted: true,
